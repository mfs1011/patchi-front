...
const currentIncomeInvoiceIdForAccept = ref(null)
...
const acceptAction = id => {
    currentIncomeInvoiceIdForAccept.value = id
...
const acceptTransferInvoice = async () => {
    ...
    try {
        await transferInvoiceStore.acceptTransferInvoice(currentIncomeInvoiceIdForAccept.value)
...
<template>
    ...
    >
        <template #buttons>
            <div class="hidden sm:flex grow gap-2 sm:gap-4 justify-end">
                ...
                <Button
                    ...
                    @click="router.push({ name: 'add-transfer-invoices' })"
                    class="px-2 sm:px-5 whitespace-nowrap"
            ...
            >
                <div class="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-2 sm:gap-4 items-center">
                    ...
                    <Select
                        ...
                        showClear
                        class="col-span-2 sm:col-span-1 md:min-w-50 max-w-full w-full bg-surface-0! dark:bg-surface-800!"
                    />
                    <SearchSelect
        ...
        <template #sectionBody>
            ...
            >
                <span class="text-surface-500 dark:text-surface-400 block whitespace-nowrap">
                    {{ t('dialog.acceptConfirmation', { name: t('transferInvoice.accusative'), id: currentIncomeInvoiceIdForAccept }) }}
                </span>
