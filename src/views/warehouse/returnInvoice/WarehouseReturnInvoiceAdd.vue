...
const items = computed(() => [{ label: t('cards.orderInvoices'), route: { name: 'warehouse-order-invoices'} }, { label: t('cards.orderInvoice'), route: { name: 'warehouse-order-invoice'} }, { label: t('buttons.newReturnInvoice') }]);
...
<template>
    ...
    <Section
        ...
        back-route-name="warehouse-order-invoice"
    >
        <template #buttons>
