...
import AuthCard from "@/volt/AuthCard.vue";
import PasswordButton from "@/volt/PasswordButton.vue";
    ...
    <div class="min-h-dvh flex bg-surface-100 dark:bg-surface-700">
        ...
        <div class="sm:max-w-120 w-full mx-auto my-auto">
            <AuthCard class="h-dvh sm:h-auto flex flex-col justify-center">
                <template #title>
                    <div class="flex justify-center mb-10 sm:mb-10 sm:mt-10">
                        <svg class="text-main dark:text-surface-0" id="Group_22937" data-name="Group 22937" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="182" height="34.499" viewBox="0 0 182 34.499">
                            <defs>
                    ...
                    <form @submit.prevent="onSubmit">
                        ...
                        <div class="relative">
                            ...
                            <PasswordButton
                                ...
                                :icon="`pi ${isPassword ? 'pi-eye-slash': 'pi-eye'}`"
                                class="absolute top-1/2 -translate-y-1/2 text-surface-400 leading-none end-3 z-1"
                            />
                        </div>
                        <Message class="h-5" size="small" severity="error" variant="simple">{{ errors.password }}</Message>
                        <Button class="mt-8" type="submit" fluid size="large" :loading="isSubmitting" loading-icon="pi pi-spinner">
                            <div class="flex justify-center items-center h-7">
                                <i v-show="isSubmitting" class="pi pi-spinner-dotted animate-spin text-xl text-surface-0" />
