...
const cards = computed(() => [
    { id: 1, name: t('cards.productsInShop'), image: 'WarehouseQuantity.png', routeName: 'shop-products-in-stock' },
    { id: 1, name: t('cards.kitsInShop'), image: 'Kits.png', routeName: 'shop-kits' },
