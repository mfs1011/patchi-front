...
<template>
    <div class="flex flex-col sm:flex-row">
        ...
        <div :class="['sm:flex-col bg-surface-0 dark:bg-surface-800 fixed z-20 sm:flex border-r border-r-surface-300 dark:border-r-surface-700 h-dvh sm:sticky top-0 flex-none transition-all overflow-hidden', sidebar.isOpen ? 'w-60 translate-x-0' : 'sm:w-20.5 -translate-x-full sm:translate-0']">
