...
function handleClear(clearCallback: () => void): void {
    clearCallback();
...
const theme = ref<SelectPassThroughOptions>({
    root: `inline-flex cursor-pointer relative select-none rounded-md p-fluid:flex
        ...
        p-disabled:bg-surface-200 p-disabled:text-surface-500 dark:p-disabled:bg-surface-900 dark:p-disabled:text-surface-400 p-disabled:pointer-events-none
    ...
    option: `cursor-pointer font-normal whitespace-nowrap relative overflow-hidden flex items-center
        ...
        p-selected:bg-main dark:p-selected:bg-green p-selected:text-surface-0 p-focus:p-selected:bg-main-hover dark:p-focus:p-selected:bg-green-hover p-focus:p-selected:text-surface-0
        transition-colors duration-200`,
    optionLabel: ``,
