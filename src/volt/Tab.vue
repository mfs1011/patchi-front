...
const theme = ref<TabPassThroughOptions>({
    root: `flex-shrink-0 cursor-pointer select-none relative whitespace-nowrap py-4 px-[1.125rem]
        border-b border-surface-200 dark:border-surface-600/50 font-semibold
        text-surface-700 dark:text-surface-400
        transition-colors duration-200 -mb-px
        not-p-active:enabled:hover:text-surface-500 dark:not-p-active:enabled:hover:text-surface-400
        p-active:border-primary p-active:text-primary dark:p-active:text-green
